...
trait Alynt_Drime_WPvivid_Uploader_Admin_Page_Notices {
	...
	private function render_notice( $notice ) {
		$messages = array(
			...
			'failed_upload_requeued'       => array( 'success', __( 'Failed upload requeued. Run the upload worker when you are ready to retry it.', 'alynt-drime-wpvivid-uploader' ) ),
			'failed_upload_missing'        => array( 'error', __( 'The failed upload could not be requeued because the local file is no longer readable.', 'alynt-drime-wpvivid-uploader' ) ),
			'failed_upload_requeue_failed' => array( 'error', __( 'The failed upload could not be requeued. Review recent events, then try again.', 'alynt-drime-wpvivid-uploader' ) ),
